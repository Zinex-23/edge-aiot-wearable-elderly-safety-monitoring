...
enum LedState : uint8_t {
    LED_BOOT = 0,      // all blink slow — device initialising (will be blue once RGB lands)
...
void setup() {
    ...
    Serial.println();
    Serial.println("=======================================================");
    Serial.println("ESP32-S3  AIFD  S3_AIFD_V1_RGB");
    ...
    // NOTE: identical to the working S3_AIFD_V1 firmware. Bonding is kept because V1 connects
    // fine with it — the connection problem in this RGB build is NOT bonding.
    NimBLEDevice::init("S3_AIFD_V1_RGB");
    ...
    Serial.println("[BOOT] Tasks started. Advertising as \"S3_AIFD_V1_RGB\"");
}
