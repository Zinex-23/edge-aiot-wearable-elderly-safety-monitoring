...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create WEDA 50Hz dataset with 6 labels.")
    parser.add_argument(
        "--input-csv",
    ...
    parser.add_argument(
        "--output-dir",
        default="/home/dsoft1/CAPSTONE/Code/data_processing/train_ready/data_set_6-label",
    )
